  ...
  return (
    <div className=" w-full md:w-1/3 bg-white border-2 border-lightText md:border-none p-5 rounded-lg shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]">
      <div>
        ...
        I will love to appreciate steven that works at kfc San Mateo as a best worker that knew how to do his job by speaking clearly,good communication skills and good work ethic.Keep it up.****
        </p>
      </div>
